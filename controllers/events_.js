...
//test function - emit push notification api
exports.testPushNotificationApi = function () {

    console.log('####################### API HIT #######################');

    //Hit Push Notification API Here
    //var url = config.baseUrl.apiServer + '/chat/notifications';
    //utility.requestServer(url, 'PUT', 'application/json', dataArray, '1.0.0')
    //    .then(function (result) {
    ...
    //    type: 'CHAT_MESSAGE'
    //};
    //helper.hitPushNotificationAPI(config.baseUrl.liveApiServer, 'chat/notifications', pushChatObj);
};

//test function - insert media in chat message api
exports.testMediaApi = function () {
    console.log('####################### API HIT #######################');
    return helper.saveFile()
        .then(function (savedFile) {
            console.log('saved file', savedFile);
        })
};

exports.testPromiseApi = function () {
    console.log('####################### API HIT #######################');
    return new Promise(function (resolve) {
        resolve(1);
    });
